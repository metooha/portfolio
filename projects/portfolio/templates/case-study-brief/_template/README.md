# Case study brief: __BRIEF_SLUG__
...
```bash
zip -r __BRIEF_SLUG__-case-study-brief.zip __BRIEF_SLUG__/
```

After scaffolding, `__BRIEF_SLUG__` matches the folder name (e.g. `acme-platform-case-study-brief.zip`).
