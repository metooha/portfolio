...
import type {ItemTileBadgeType} from '../patterns/ItemTile/ItemTile';
...
import {NewArrivalsCarousel, type CarouselSlide} from '../patterns/NewArrivalsCarousel/NewArrivalsCarousel';
import {
  getCategories,
  getAllProducts,
  getHeroBanners,
