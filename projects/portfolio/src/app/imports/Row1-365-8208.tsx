import svgPaths from "./svg-s0k2ku2nej";
    ...
    <div className="flex-[1_0_0] h-full min-h-px min-w-px relative" data-name="Image">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pl-[16px] py-[16px] relative size-full">
          <img src={imgTokens} alt="Tokens diagram showing semantic token mapping to card components" className="w-full h-auto object-contain" />
        </div>
      </div>
    </div>
  );
