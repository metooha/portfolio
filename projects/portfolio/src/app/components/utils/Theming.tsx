...
export const DEFAULT_THEME: ThemeName = 'Portfolio';
...
export const THEME_PRESETS: Record<string, ThemePreset> = {
  'Portfolio': {
    description: "Amy's portfolio brand — purple CTAs and indigo accents",
    primaryColor: '#4F39F6',
  },
  'WM': {
    description: 'Waste Management rebrand — WM.com greens',
    primaryColor: '#006937',
  },
  'Oportun': {
...
const FONT_IMPORTERS: Record<string, FontImporter> = {
  'ld':             () => import('../../assets/walmart-assets/fonts/ld/font.css'),
  'wcp':            () => import('../../assets/walmart-assets/fonts/wcp/font.css'),
  'sams-club':      () => import('../../assets/walmart-assets/fonts/sams-club/font.css'),
  'ax':             () => import('../../assets/walmart-assets/fonts/ax/font.css'),
  'ax-sams-club':   () => import('../../assets/walmart-assets/fonts/ax-sams-club/font.css'),
  'px':             () => import('../../assets/walmart-assets/fonts/px/font.css'),
  'px-sams-club':   () => import('../../assets/walmart-assets/fonts/px-sams-club/font.css'),
  'bodega':         () => import('../../assets/walmart-assets/fonts/bodega/font.css'),
};

const TEXT_FONT_IMPORTERS: Record<TextFontKey, FontImporter> = {
  'inter':         () => import('../../assets/walmart-assets/fonts/inter/font.css'),
  'everyday-sans': () => import('../../assets/walmart-assets/fonts/everyday-sans/font.css'),
  'gibson':        () => import('../../assets/walmart-assets/fonts/gibson/font.css'),
  'bogle':         () => import('../../assets/walmart-assets/fonts/bogle/font.css'),
  'maax':          () => import('../../assets/walmart-assets/fonts/maax/font.css'),
  'calibre':       () => import('../../assets/walmart-assets/fonts/calibre/font.css'),
  'tt-commons':    () => import('../../assets/walmart-assets/fonts/tt-commons/font.css'),
};
...
export function loadTextFont(fontKey: TextFontKey): void {
...
export interface ApplyThemeOptions {
  /** Persist the theme name to localStorage. Default true. */
  persist?: boolean;
  /** Dispatch the `ld-kit-theme-change` event. Default true. */
  notify?: boolean;
}
