...
import '../../assets/walmart-assets/fonts/ld/font.css';

export {LD_ICON_CODEPOINTS} from '../../assets/walmart-assets/fonts/ld/LDIcons';
...
/** TV / desktop preview — not in the bundled LD icon font subset. */
export const TvIcon = ({ size = 'medium', a11yLabel, decorative, style, className }: IconProps) => {
  const px = SIZES[size ?? 'medium'];
  const a11y = a11yLabel
    ? { 'aria-label': a11yLabel, role: 'img' as const }
    : { 'aria-hidden': true as const };
  return (
    ...
    >
      <path d="M20 4H4c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h6v2H8v2h8v-2h-2v-2h6c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2Zm0 12H4V6h16v10Z" />
    </svg>
  );
};
