...
import {useStableId, applyCommonProps, setStyleProperty} from '@/app/components/common/helpers';
import {useCSSTransition} from '@/app/components/common/useCSSTransition';
