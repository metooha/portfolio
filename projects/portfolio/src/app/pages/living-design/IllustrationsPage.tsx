...
import manifest from '@/living-design/illustrations/manifest.json';
...
export default function IllustrationsPage() {
  ...
  return (
    <PageWrapper
      title="Illustrations"
      category="Media"
      description={`SVG illustrations across ${TYPE_TABS.length} types from the Living Design Airtable. Switch tabs to browse each illustration size.`}
    >
