...
import imgFormFields2X1 from "@/app/assets/pages/case-study/wm-rebrand/form-fields2-x1.png";
import imgButtonsDesktop1X from "@/app/assets/pages/case-study/wm-rebrand/buttons-desktop1-x.png";
...
export function WmCaseStudyProblemSpaceSection() {
  return <Section />;
}
