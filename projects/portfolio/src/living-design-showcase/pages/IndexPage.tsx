...
import {initTheme, initMegaMode} from '@/living-design/utils/themeManager';
...
function PageRouter({route, navigate}: {route: string; navigate: (r: string) => void}) {
  switch (route) {
    ...
    case 'components-living-design': return <LivingDesignPage />;
...
export default function Index() {
  ...
  React.useEffect(() => { initTheme(); initMegaMode(); }, []);
        ...
        <main style={{
          ...
          {isDrawer && (
            ...
            >
              ...
              <span style={{fontSize: '14px', fontWeight: 700, color: '#2E2F32', letterSpacing: '-0.2px'}}>Living Design</span>
            </header>
          )}
