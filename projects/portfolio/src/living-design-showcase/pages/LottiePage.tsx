...
import manifest from '@/living-design/lottie/manifest.json';
import { LOTTIE_DATA, LOTTIE_FORMATS, LOTTIE_TOKENS } from '@/living-design/lottie/index';
...
export default function LottiePage() {
  ...
  return (
    <PageWrapper
      ...
      category="Media"
      description="Lottie and dotLottie animation assets from the Living Design Airtable ANIMATE tokens. Each animation ships as base64-encoded data ready for use with @lottiefiles/dotlottie-react or lottie-web."
    >
      <ExampleSection>
        {items.length > 0 && (
          <div
