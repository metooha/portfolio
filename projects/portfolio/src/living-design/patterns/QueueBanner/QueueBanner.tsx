...
import {ExclamationCircleIcon, CloseIcon, ChevronRightIcon} from '@/living-design/components/Icons';
import {TimerView, TimerViewVariant} from '@/living-design/components/TimerView';
