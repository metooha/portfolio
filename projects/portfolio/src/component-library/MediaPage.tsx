...
import manifest from '@/app/assets/walmart-assets/media/manifest.json';
...
export default function MediaPage() {
  ...
  return (
    <PageWrapper
      title="Brand Media"
      category="Media"
      description={`Tenant-specific brand assets (logos, wordmarks, card art, error states) synced from the Component Library Airtable. Each tab extends WCP and overrides the tokens that differ. ${THEME_TABS.length} themes.`}
    >
