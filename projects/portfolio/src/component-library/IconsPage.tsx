...
import {loadIconFont} from '@/app/components/utils/Theming';
import manifest from '@/app/assets/walmart-assets/fonts/icon-manifest.json';
...
export default function IconsPage() {
  ...
  return (
    <PageWrapper
      title="Icons"
      category="Media"
      description={`Catalog of icons across ${BRAND_TABS.length} Component Library brand fonts. Switch tabs to browse each font.`}
    >
