...
import {Illustration, IllustrationType, IllustrationName} from '@/app/components/utils/Illustration';
import {MEDIA_SVGS, MEDIA_IMAGES} from '@/app/assets/walmart-assets/media';
