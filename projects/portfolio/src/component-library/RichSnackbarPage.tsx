...
import {CartIcon, GiftIcon} from '@/app/components/Icons/Icons';
import {
  RichSnackbar,
  ...
  useWCPRichSnackbar,
} from '@/app/components/RichSnackbar/RichSnackbar';
import {Body} from '@/app/components/Text/Text';
import {Illustration} from '@/app/components/utils/Illustration';
import {
    ...
    >
      ...
      >
        <DocsGrid>
          ...
          <DocsCard title="Media" description="A system illustration as richer visual context.">
            <RichSnackbar
              inline
              color="primary"
