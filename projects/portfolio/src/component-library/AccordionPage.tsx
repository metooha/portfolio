...
const FAQ_ITEMS = [
  {value: '1', title: 'What is this component system?', body: 'This is a portable design system that provides consistent UI components across different platforms and frameworks.'},
