import svgPaths from "./svg-y681stfumt";
...
import { imgImage1 } from "./svg-vyqej";
...
function MaskGroup() {
  return (
    <div 
      className="relative w-full h-[680px] overflow-visible" 
      data-name="Mask Group"
    >
      <div className="absolute h-[680px] left-[0.11%] mask-alpha mask-intersect mask-no-clip mask-no-repeat shadow-[0px_2px_8px_0px_rgba(0,0,0,0.1)] top-0 w-[50%]" data-name="image 1" style={{ maskImage: `url('${imgImage1}')`, maskSize: '100% 100%', maskPosition: 'center' }}>
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage2} />
      </div>
      <div className="absolute h-[680px] left-[16.78%] mask-alpha mask-intersect mask-no-clip mask-no-repeat shadow-[0px_2px_8px_0px_rgba(0,0,0,0.1)] top-0 w-[50%]" data-name="image 2" style={{ maskImage: `url('${imgImage1}')`, maskSize: '100% 100%', maskPosition: 'center' }}>
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage3} />
      </div>
      <div className="absolute h-[680px] left-[33.46%] mask-alpha mask-intersect mask-no-clip mask-no-repeat shadow-[0px_2px_8px_0px_rgba(0,0,0,0.1)] top-0 w-[50%]" data-name="image 3" style={{ maskImage: `url('${imgImage1}')`, maskSize: '100% 100%', maskPosition: 'center' }}>
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage4} />
      </div>
      <div className="absolute h-[680px] left-[50.11%] mask-alpha mask-intersect mask-no-clip mask-no-repeat shadow-[0px_2px_8px_0px_rgba(0,0,0,0.1)] top-0 w-[50%]" data-name="Form Fields@2x 1" style={{ maskImage: `url('${imgImage1}')`, maskSize: '100% 100%', maskPosition: 'center' }}>
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgFormFields2X1} />
      </div>
      <div className="absolute h-[680px] left-[66.78%] mask-alpha mask-intersect mask-no-clip mask-no-repeat shadow-[0px_2px_8px_0px_rgba(0,0,0,0.1)] top-0 w-[82.45%]" data-name="Buttons - Desktop@1x" style={{ maskImage: `url('${imgImage1}')`, maskSize: '100% 100%', maskPosition: 'center' }}>
