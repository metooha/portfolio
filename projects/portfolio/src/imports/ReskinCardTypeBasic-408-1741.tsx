import svgPaths from "./svg-qm79bj9150";
...
export default function ReskinCardTypeBasic() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[8px] items-start justify-start p-[16px] relative rounded-[8px] size-full" data-name="Reskin Card type / Basic">
