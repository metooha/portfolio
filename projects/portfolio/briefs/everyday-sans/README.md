# Case study brief: everyday-sans
...
```bash
zip -r everyday-sans-case-study-brief.zip everyday-sans/
```

After scaffolding, `everyday-sans` matches the folder name (e.g. `acme-platform-case-study-brief.zip`).
